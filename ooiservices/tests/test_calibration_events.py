#!/usr/bin/env python
"""
Specific testing for calibration event routes and supporting functions.
...
class CalibrationEventsTestCase(unittest.TestCase):
    ...
    def test_calibration_event_scalar(self):
        """
        ...
        input = self.calibration_data_for_create(event_type, instrument_uid, instrument_rd)
        ...
        self.assertEquals(len(event_keys), len(update_data_keys)-1)
    ...
    def test_calibration_event_scalar_negative(self):
        """
        Create CALIBRATION_DATA event. Only applied for instrument ('Sensor') assets.
        http://uframe-3-test.ooi.rutgers.edu:12587/asset/cal?uid=A00679, or,
        http://uframe-3-test.ooi.rutgers.edu:12587/asset?uid=A00679
    ...
    #- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    def calibration_data_for_create(self, event_type, uid, rd):
        input = {}
        debug = False
    ...
    #- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    # Negative test. Create calibration event which already exists.
    #- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
