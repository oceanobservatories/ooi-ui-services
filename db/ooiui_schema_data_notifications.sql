...
insert into user_event_notifications(id, system_event_definition_id, user_id, use_email, use_redmine, use_phone, use_log, use_sms) values (3, 3, 1, False, True, False, False, False);
